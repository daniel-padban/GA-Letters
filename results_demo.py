...
# Create tuples of (test_df, train_df)
    ...
    train_F1s = [test_aggs[group][:,[0,1]] for group in groups]
    train_accs = [test_aggs[group][:,[0,2]]*100 for group in groups] # *100 for percentage
    train_CO_losses =[test_aggs[group][:,[0,3]] for group in groups]
